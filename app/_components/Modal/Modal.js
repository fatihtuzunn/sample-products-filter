        ...
        showModal ? (
            <>
                ...
                >
                    ...
                    >
                        <div className="relative max-w-4xl max-sm:max-w-xs">
                            <div
                                style={{ backgroundColor: "#FF006D" }}
                                className="absolute z-10 inset-0 bg-gradient-to-r shadow-lg transform -skew-y-6 sm:skew-y-0 sm:-rotate-6 sm:rounded-lg"
                            ></div>
                            <div
                            ...
                            >
                                ...
                                >
                                    ...
                                    <div className='flex justify-around '>
                                        <p className="text-xl leading-relaxed mr-auto">
                                    ...
                                    <div className='flex justify-between'>
                                        <div>
                                            <div>
                                                <h2 className="text-lg font-bold mb-2">İletişim bilgileri:</h2>
                                            ...
                                            <ul>
                                                ...
                                                <li>
                                                    ...
                                                    <a className="inline-block h-12 -my-4 xs:h-auto underline hover:no-underline" href="mailto:john@doe.com">{modalData.email}</a>
                                                </li>
                                                <li>
                                        ...
                                        <div>
                                            <div>
                                                <h2 className="text-lg font-bold">İlgi alanları</h2>
          ...
          "
                                            >
                                                ...
                                                {modalData.hobbies.slice(0, 3).map(hobby => (
                                                    <a key={hobby} href="#" className="m-1 px-2 py-1 rounded bg-green-500"> #{hobby} </a>
                                    ...
                                    <div className="flex flex-col w-full" >
                                        <div className="grid gap-4 grid-cols-1 sm:grid-cols-2 my-2 w-full">
                                            <div className="instagram metric-card bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-800 rounded-lg p-4 max-w-72 w-full" >
                                            ...
                                            <div className="tiktok metric-card dark:bg-gray-900 border border-gray-200 dark:border-gray-800 rounded-lg p-4 max-w-72 w-full" >
                                                <a aria-label="Unsplash Views" target="_blank" rel="noopener noreferrer" href="https://stackdiary.com/">
                                                    <div className="flex items-center text-gray-100" >Tiktok Followers
                                                        <svg className="h-4 w-4 ml-1" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M10 6H6a2 2 0 00-2 2v10a2 2 0 002 2h10a2 2 0 002-2v-4M14 4h6m0 0v6m0-6L10 14"></path>
                                                        </svg>
                                                    </div>
                                                </a>
                                                <p className="mt-2 text-3xl font-bold spacing-sm text-white dark:text-white" >{modalData.tiktok.followers}</p>

                                                <div className="flex items-center text-gray-100 mt-2" >
                                                    Tiktok Avarage Like
                                                </div>

                                                <p className="mt-2 text-3xl font-bold spacing-sm text-white dark:text-white" >{modalData.insta.average_like}</p>
                                            </div>
                                        </div>
                                        <div className="grid gap-4 grid-cols-1 sm:grid-cols-2 my-2 w-full">
                                            <div className="metric-card bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-800 rounded-lg p-4 max-w-72 w-full" >
                                                <a aria-label="YouTube Subscribers" target="_blank" rel="noopener noreferrer" href="https://stackdiary.com/">
                                                    <div className="flex items-center text-gray-900 dark:text-gray-100" >Avarage Like
                                                        <svg className="h-4 w-4 ml-1" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M10 6H6a2 2 0 00-2 2v10a2 2 0 002 2h10a2 2 0 002-2v-4M14 4h6m0 0v6m0-6L10 14"></path>
                                                        </svg>
                                                    </div>
                                                </a>
                                                <p className="mt-2 text-3xl font-bold spacing-sm text-black dark:text-white" >56</p>
                                            </div>
                                            <div className="metric-card bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-800 rounded-lg p-4 max-w-72 w-full" >
                                                <a aria-label="YouTube Views" target="_blank" rel="noopener noreferrer" href="https://stackdiary.com/">
                                                    <div className="flex items-center text-gray-900 dark:text-gray-100">Total Post Number
                                                        <svg className="h-4 w-4 ml-1" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" >
                                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M10 6H6a2 2 0 00-2 2v10a2 2 0 002 2h10a2 2 0 002-2v-4M14 4h6m0 0v6m0-6L10 14"></path>
                                                        </svg>
                                                    </div>
                                                </a>
                                                <p className="mt-2 text-3xl font-bold spacing-sm text-black dark:text-white" >5</p>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div >
                                    <img
                                        ...
                                        className="flex-shrink-0 rounded-full border-6 border-white shadow-md"
                                    />
                                    <button
